                ...
                <div class="container px-5">
                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                        <div class="text-center mb-5">
                            ...
                            <h1 class="fw-bolder">Product Update</h1>
                            <p class="lead fw-normal text-muted mb-0">Let's go Update!!</p>
                        </div>
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                         
                                <form id="contactForm" action="/product/update" method="POST">
                                    <!-- Name input-->
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid"><button class="btn btn-primary btn-lg" id="submitButton" type="submit">상품 수정</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
