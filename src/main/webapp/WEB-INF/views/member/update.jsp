					...
					<form method="post" action="./update" >
						<div class="mb-3">
							<label for="userName" class="form-label">I D</label> <input
								type="text" value="${member.userName}" disabled class="form-control" id="userName" name="userName"
						...
						<input type="text" id="sample6_address" name="address" value="${member.address}" placeholder="address 입력하세요"><br> 
